...
class Weather:
    ...
    WEATHER_EMOJIS = {
        ...
        "阵雨": "🌦️", "雷阵雨": "⛈️", "雷阵雨并伴有冰雹": "⛈️ℹ️",
        "小雨": "🌧️", "毛毛雨/细雨": "🌧️", "雨": "🌧️", "中雨": "🌧️", "大雨": "🌧️", 
        "暴雨": "⛈️", "大暴雨": "⛈️", "特大暴雨": "⛈️",
        "小雪": "🌨️", "中雪": "🌨️", "大雪": "❄️", "暴雪": "❄️", "雪": "❄️",
        "雨夹雪": "🌨️", "冻雨": "❄️",
        "霾": "😷", "中度霾": "😷", "重度霾": "😷", "严重霾": "😷",
        "雾": "🌫️", "浓雾": "🌫️", "大雾": "🌫️", "轻雾": "🌫️",
        "浮尘": "🍂", "扬沙": "🍂", "沙尘暴": "🌪️", "强沙尘暴": "🌪️", "龙卷风": "🌪️",
        "有风": "💨", "微风": "🍃", "和风": "🍃", "清风": "🍃", "大风": "💨", "强风/劲风": "💨",
        "热": "🌡️🔥", "冷": "🌡️❄️", "未知": "❓"
    }
    ...
    @staticmethod
    def build_weather_message(forecasts: list[dict[str, Any]] | None, parse_mode: str = "html", address: str | None = None) -> str:
        """
        ...
        # 组合当前天气表现
        weather_status = f"{day_weather}转{night_weather}" if day_weather != night_weather else day_weather
        ...
        wind_status = day_wind_str if day_wind_str == night_wind_str else f"{day_wind_str} 转 {night_wind_str}"
        ...
        if mode == "html":
            ...
            city_esc = f"{Weather.escape_markdown_v2(address)}" if address else Weather.escape_markdown_v2(city_name)
